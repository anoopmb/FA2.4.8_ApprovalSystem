-- Approval System start
ALTER TABLE 0_gl_trans MODIFY COLUMN tran_date date  DEFAULT NULL;
ALTER TABLE 0_audit_trail MODIFY COLUMN gl_date date  DEFAULT NULL;
